      ...
      <div className="p-4">
        ...
        <ClerkLoaded>
          <UserButton
            ...
            appearance={{
              elements: {
                userButtonPopoverCard: { pointerEvents: "initial" }, // Força o clique a funcionar
